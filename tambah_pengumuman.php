...
if (isset($_POST['submit'])) {
  ...
  if (count($pesanError) >= 1) {
      ...
      if (move_uploaded_file($tmp, $path)) {
          $query=mysql_query("INSERT INTO pengumuman(judul_peng,isi_peng,tanggal_peng,gambar) VALUES ('".$judul."','".$isi."','".$tanggal."','".$gambar."')") or die("gagal query!".mysql_error());
      if ($query) {
        #refresh
...
<div class="row">
    ...
    <textarea class="form-control" id="isi" name="isi_peng" rows="3"></textarea>
    </div>
